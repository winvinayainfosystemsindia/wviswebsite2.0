...
export const primaryNavItems: NavItem[] = [
  ...
  },
  {
    ...
    label: 'Services',
    children: [
      { id: 'accessibility-audit-testing', label: 'Accessibility Audit & Testing', href: '/services/accessibility-audit-testing' },
      {
      ...
      { id: 'corporate-training', label: 'Corporate Training', href: '/services/corporate-training' },
      {
      ...
      { id: 'capacity-building-adoption', label: 'Capacity Building & Adoption', href: '/services/capacity-building-adoption' },
