...
const InteractiveArchitecturePreview = styled(Box)(({ theme }) => ({
  position: 'absolute',
...
const TRUST_CREDENTIALS = [
  {
    ...
    detail: 'We depend daily on the very software and AI agents we build for our own operations.',
  },
  {
    icon: SmartToyOutlinedIcon,
    tone: 'accent' as const,
    title: 'Embedded Workflow AI',
    detail: 'Intelligent decision agents woven directly into business logic, not cosmetic chatbot widgets.',
  },
  {
    icon: AccessibleOutlinedIcon,
    tone: 'info' as const,
    title: 'Accessible by Default',
    detail: 'Enterprise internal tools and portals engineered to be 100% usable for all team members.',
  },
]

export const AgenticHeroSection = () => (
  <Root aria-labelledby="agentic-hero-heading">
      ...
      <Grid container spacing={{ xs: 5, md: 6, lg: 8 }} sx={{ alignItems: 'center' }}>
        ...
        <Grid size={{ xs: 12, md: 7, lg: 6 }}>
          <Stack spacing={3.5}>
            ...
            >
              {agenticHeroData.headline} <GradientText>{agenticHeroData.headlineHighlight}</GradientText>
            </Typography>
            ...
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2} sx={{ pt: 1 }}>
              <Button
                tone="primary"
                variant="contained"
                href={agenticHeroData.primaryCta.href}
                size="large"
              ...
              >
                {agenticHeroData.primaryCta.label}
              </Button>

              <Button
                variant="outlined"
                size="large"
                href={agenticHeroData.secondaryCta.href}
                sx={(theme) => ({
                  px: 3.5,
                  py: 1.6,
                  fontSize: '1.0625rem',
              ...
              >
                {agenticHeroData.secondaryCta.label}
              </Button>
            </Stack>

            {/* Key Stat Pills */}
            <Stack direction="row" spacing={1.5} sx={{ pt: 1, flexWrap: 'wrap', gap: 1.5 }}>
              {agenticHeroData.stats.map((stat, idx) => (
        ...
        <Grid size={{ xs: 12, md: 5, lg: 6 }}>
          <Box sx={{ position: 'relative', px: { xs: 0, sm: 2, md: 0 } }}>
            <VisualFrame>
              <VisualImage
                role="img"
                aria-label="WinVinaya engineers developing enterprise MIS systems and autonomous AI agent workflows."
              >
                {/* Live Process Architecture Card */}
                <InteractiveArchitecturePreview>
                  ...
                  <Grid container spacing={1} sx={{ pt: 0.5 }}>
                    <Grid size={{ xs: 6 }}>
                      <Stack direction="row" spacing={0.75} sx={{ alignItems: 'center' }}>
                        ...
                        <Typography variant="caption" sx={{ fontWeight: 600, fontSize: '0.75rem' }}>
                          crm.winvinaya.com MIS
                        </Typography>
                      </Stack>
                    </Grid>
                    <Grid size={{ xs: 6 }}>
                      <Stack direction="row" spacing={0.75} sx={{ alignItems: 'center' }}>
                        <AutoFixHighOutlinedIcon sx={{ fontSize: 16, color: 'accent.main' }} />
                        <Typography variant="caption" sx={{ fontWeight: 600, fontSize: '0.75rem' }}>
                          a11ysense WCAG AI
                        </Typography>
                      </Stack>
                    ...
                    <Grid size={{ xs: 6 }}>
                      <Stack direction="row" spacing={0.75} sx={{ alignItems: 'center' }}>
                        <SpeedOutlinedIcon sx={{ fontSize: 16, color: 'accent.main' }} />
                        <Typography variant="caption" sx={{ fontWeight: 600, fontSize: '0.75rem' }}>
