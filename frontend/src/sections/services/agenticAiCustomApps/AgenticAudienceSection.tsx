...
import { agenticAudienceData } from '../../../data/services/agenticAiCustomApps'

const AUDIENCE_ICONS: Record<string, ReactNode> = {
  'spreadsheet-replacers': <TableChartOutlinedIcon />,
  'ngos-enterprises-ai': <SmartToyOutlinedIcon />,
  'custom-needs': <TuneOutlinedIcon />,
  'accessible-internal-tools': <AccessibleForwardOutlinedIcon />,
}
...
export const AgenticAudienceSection = () => (
  <Box
    component="section"
    aria-labelledby="agentic-audience-heading"
    sx={(theme) => ({
  ...
  >
    <Container maxWidth="xl" sx={{ py: { xs: 8, md: 12 } }}>
      <Stack spacing={{ xs: 6, md: 8 }} sx={{ alignItems: 'center' }}>
        <SectionHeading
          headingId="agentic-audience-heading"
          eyebrow={agenticAudienceData.eyebrow}
          heading={agenticAudienceData.heading}
          description={agenticAudienceData.description}
          maxWidth={720}
        />

        <Grid container spacing={3} sx={{ width: '100%' }}>
          {agenticAudienceData.items.map((item) => (
