...
import { agenticDeliverablesData } from '../../../data/services/agenticAiCustomApps'
...
export const AgenticDeliverablesSection = () => (
  <Box component="section" aria-labelledby="agentic-deliverables-heading" sx={{ bgcolor: 'background.paper' }}>
    <Container maxWidth="xl" sx={{ py: { xs: 8, md: 12 } }}>
      <Stack spacing={{ xs: 6, md: 8 }} sx={{ alignItems: 'center' }}>
        <SectionHeading
          headingId="agentic-deliverables-heading"
          eyebrow={agenticDeliverablesData.eyebrow}
          heading={agenticDeliverablesData.heading}
          description={agenticDeliverablesData.description}
          maxWidth={720}
        />

        <Grid container spacing={3} sx={{ width: '100%' }}>
          {agenticDeliverablesData.items.map((item, idx) => (
