...
import { whatWeBuildData } from '../../../data/services/agenticAiCustomApps'

const BUILD_ICONS: Record<string, ReactNode> = {
  'agentic-ai': <SmartToyOutlinedIcon />,
  'custom-enterprise': <AppRegistrationOutlinedIcon />,
  'ai-internal-tools': <BuildCircleOutlinedIcon />,
}
    ...
    <Container maxWidth="xl" sx={{ py: { xs: 8, md: 12 } }}>
      <Stack spacing={{ xs: 6, md: 8 }} sx={{ alignItems: 'center' }}>
        <SectionHeading
          ...
          eyebrow={whatWeBuildData.eyebrow}
          heading={whatWeBuildData.heading}
          description={whatWeBuildData.description}
          maxWidth={760}
        />

        <Grid container spacing={3.5} sx={{ width: '100%' }}>
          {whatWeBuildData.solutions.map((item) => (
