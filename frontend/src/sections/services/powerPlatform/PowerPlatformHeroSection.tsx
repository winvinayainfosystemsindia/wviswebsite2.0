...
const InteractiveDashboardPreview = styled(Box)(({ theme }) => ({
  position: 'absolute',
...
const TRUST_CREDENTIALS = [
  {
    ...
    detail: 'Built directly on your live schemas, databases, and metrics — zero generic demo datasets.',
  },
  {
    icon: AccessibilityNewOutlinedIcon,
    tone: 'accent' as const,
    title: 'Accessible by Design',
    detail: 'Visual reports and Power Apps engineered with screen-reader compatibility and color-blind friendly cues.',
  },
  {
    icon: HandshakeOutlinedIcon,
    tone: 'info' as const,
    title: '3-Phase Handover Lifecycle',
    detail: 'Discovery → Co-Building → Full Handover so your team maintains and scales what is built independently.',
  },
]

export const PowerPlatformHeroSection = () => (
  <Root aria-labelledby="power-platform-hero-heading">
      ...
      <Grid container spacing={{ xs: 5, md: 6, lg: 8 }} sx={{ alignItems: 'center' }}>
        ...
        <Grid size={{ xs: 12, md: 7, lg: 6 }}>
          <Stack spacing={3.5}>
            <Chip
              icon={<PulseDot />}
              label={powerPlatformHeroData.eyebrow}
              variant="outlined"
              size="medium"
              sx={(theme) => ({
            ...
            <Typography
              id="power-platform-hero-heading"
              variant="display"
              component="h1"
              sx={(theme) => ({
                color: theme.palette.text.primary,
            ...
            >
              {powerPlatformHeroData.headline} <GradientText>{powerPlatformHeroData.headlineHighlight}</GradientText>
            </Typography>
            ...
            >
              {powerPlatformHeroData.subheadline}
            </Typography>
            ...
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2} sx={{ pt: 1 }}>
              <Button
                tone="primary"
                variant="contained"
                href={powerPlatformHeroData.primaryCta.href}
                size="large"
              ...
              >
                {powerPlatformHeroData.primaryCta.label}
              </Button>

              <Button
                variant="outlined"
                size="large"
                href={powerPlatformHeroData.secondaryCta.href}
                sx={(theme) => ({
                  px: 3.5,
                  py: 1.6,
                  fontSize: '1.0625rem',
              ...
              >
                {powerPlatformHeroData.secondaryCta.label}
              </Button>
            </Stack>

            {/* Key Stat Pills */}
            <Stack direction="row" spacing={1.5} sx={{ pt: 1, flexWrap: 'wrap', gap: 1.5 }}>
              {powerPlatformHeroData.stats.map((stat, idx) => (
        ...
        <Grid size={{ xs: 12, md: 5, lg: 6 }}>
          <Box sx={{ position: 'relative', px: { xs: 0, sm: 2, md: 0 } }}>
            <VisualFrame>
              <VisualImage
                role="img"
                aria-label="WinVinaya practitioners building accessible Power BI dashboards, Power Apps, and Power Automate workflows."
              >
                {/* Live Process Architecture Card */}
                <InteractiveDashboardPreview>
                  ...
                  <Grid container spacing={1} sx={{ pt: 0.5 }}>
                    ...
                    <Grid size={{ xs: 6 }}>
                      <Stack direction="row" spacing={0.75} sx={{ alignItems: 'center' }}>
                        <AccountTreeOutlinedIcon sx={{ fontSize: 16, color: 'accent.main' }} />
                        <Typography variant="caption" sx={{ fontWeight: 600, fontSize: '0.75rem' }}>
                          Power Apps Portals
                        </Typography>
                      </Stack>
                    ...
                    <Grid size={{ xs: 6 }}>
                      <Stack direction="row" spacing={0.75} sx={{ alignItems: 'center' }}>
                        <SyncAltOutlinedIcon sx={{ fontSize: 16, color: 'accent.main' }} />
                        <Typography variant="caption" sx={{ fontWeight: 600, fontSize: '0.75rem' }}>
                          Automate Approvals
                        </Typography>
                      </Stack>
                    ...
                    <Grid size={{ xs: 6 }}>
                      <Stack direction="row" spacing={0.75} sx={{ alignItems: 'center' }}>
                        <VerifiedUserOutlinedIcon sx={{ fontSize: 16, color: 'accent.main' }} />
                        <Typography variant="caption" sx={{ fontWeight: 600, fontSize: '0.75rem' }}>
                          Accessible Color & Tabs
                        </Typography>
                      </Stack>
                    </Grid>
                  </Grid>
            ...
            >
              ...
              >
                <AccessibleForwardOutlinedIcon sx={{ fontSize: 26 }} />
              </Box>
              <Box>
                <Typography variant="subtitle2" sx={{ fontWeight: 800, color: 'text.primary', lineHeight: 1.2 }}>
