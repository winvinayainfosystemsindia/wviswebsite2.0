...
import { remediationDeliverablesData } from '../../../data/services/documentRemediation'
...
export const RemediationDeliverablesSection = () => (
  <Box
    component="section"
    aria-labelledby="remediation-deliverables-heading"
    sx={(theme) => ({
  ...
  >
    <Container maxWidth="xl" sx={{ py: { xs: 8, md: 12 } }}>
      <Stack spacing={{ xs: 6, md: 8 }} sx={{ alignItems: 'center' }}>
        <SectionHeading
          headingId="remediation-deliverables-heading"
          eyebrow={remediationDeliverablesData.eyebrow}
          heading={remediationDeliverablesData.heading}
          description={remediationDeliverablesData.description}
          maxWidth={720}
        />

        <Grid container spacing={3} sx={{ width: '100%' }}>
          {remediationDeliverablesData.items.map((item, idx) => (
