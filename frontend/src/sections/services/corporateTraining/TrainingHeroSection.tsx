...
const InteractiveCurriculumPreview = styled(Box)(({ theme }) => ({
  position: 'absolute',
...
const TRUST_CREDENTIALS = [
  {
    ...
    title: 'Evergrowing Curriculum',
    detail: 'Continuously updated to match what engineering, QA, and business teams are actually asked to adopt today.',
  },
  {
    icon: GroupWorkOutlinedIcon,
    tone: 'accent' as const,
    title: '3-Phase Handover Lifecycle',
    detail: 'Workshop → Co-Building on Live Data → Independent Handover so skills stay permanently in-house.',
  },
  {
    icon: AccessibleForwardOutlinedIcon,
    tone: 'info' as const,
    title: 'Accessible & Inclusive by Default',
    detail: 'Inclusive pacing, multi-modal delivery formats, and materials designed for universal learner engagement.',
  },
]

export const TrainingHeroSection = () => (
  <Root aria-labelledby="training-hero-heading">
      ...
      <Grid container spacing={{ xs: 5, md: 6, lg: 8 }} sx={{ alignItems: 'center' }}>
        ...
        <Grid size={{ xs: 12, md: 7, lg: 6 }}>
          <Stack spacing={3.5}>
            <Chip
              icon={<PulseDot />}
              label={corporateTrainingHeroData.eyebrow}
              variant="outlined"
              size="medium"
              sx={(theme) => ({
            ...
            >
              {corporateTrainingHeroData.headline} <GradientText>{corporateTrainingHeroData.headlineHighlight}</GradientText>
            </Typography>
            ...
            >
              {corporateTrainingHeroData.subheadline}
            </Typography>
            ...
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2} sx={{ pt: 1 }}>
              <Button
                tone="primary"
                variant="contained"
                href={corporateTrainingHeroData.primaryCta.href}
                size="large"
              ...
              >
                {corporateTrainingHeroData.primaryCta.label}
              </Button>

              <Button
                variant="outlined"
                size="large"
                href={corporateTrainingHeroData.secondaryCta.href}
                sx={(theme) => ({
                  px: 3.5,
                  py: 1.6,
                  fontSize: '1.0625rem',
              ...
              >
                {corporateTrainingHeroData.secondaryCta.label}
              </Button>
            </Stack>

            {/* Key Stat Pills */}
            <Stack direction="row" spacing={1.5} sx={{ pt: 1, flexWrap: 'wrap', gap: 1.5 }}>
              {corporateTrainingHeroData.stats.map((stat, idx) => (
        ...
        <Grid size={{ xs: 12, md: 5, lg: 6 }}>
          <Box sx={{ position: 'relative', px: { xs: 0, sm: 2, md: 0 } }}>
            <VisualFrame>
              <VisualImage
                role="img"
                aria-label="WinVinaya practitioners delivering hands-on technical training on Generative AI, Power Platform, and Playwright automation."
              >
                {/* Interactive Live Stack Card */}
                <InteractiveCurriculumPreview>
                  ...
                  <Grid container spacing={1} sx={{ pt: 0.5 }}>
                    ...
                    <Grid size={{ xs: 6 }}>
                      <Stack direction="row" spacing={0.75} sx={{ alignItems: 'center' }}>
                        <AutoAwesomeOutlinedIcon sx={{ fontSize: 16, color: 'accent.main' }} />
                        <Typography variant="caption" sx={{ fontWeight: 600, fontSize: '0.75rem' }}>
                          Applied GenAI Sprints
                        </Typography>
                      </Stack>
                    </Grid>
                    <Grid size={{ xs: 6 }}>
            ...
            >
              ...
              >
                <CastForEducationOutlinedIcon sx={{ fontSize: 26 }} />
              </Box>
              <Box>
                <Typography variant="subtitle2" sx={{ fontWeight: 800, color: 'text.primary', lineHeight: 1.2 }}>
                  Trainer Enablement
                ...
                <Typography variant="caption" sx={{ color: 'text.secondary', fontSize: '0.75rem', fontWeight: 500 }}>
                  Build In-House Capability That Lasts
                </Typography>
              </Box>
            </GlassCard>
