...
import { deliverablesData } from '../../../data/services/accessibilityAudit'
...
export const AuditDeliverablesSection = () => (
  <Box
    component="section"
    ...
    <Container maxWidth="xl" sx={{ py: { xs: 8, md: 12 } }}>
      <Stack spacing={{ xs: 6, md: 8 }} sx={{ alignItems: 'center' }}>
        <SectionHeading
          ...
          eyebrow={deliverablesData.eyebrow}
          heading={deliverablesData.heading}
          maxWidth={680}
        />

        <Grid container spacing={3} sx={{ width: '100%' }}>
          {deliverablesData.items.map((item, idx) => (
