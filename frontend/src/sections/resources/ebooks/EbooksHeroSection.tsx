...
import { ebooksHeroData } from '../../../data/resources/ebooks'
...
export const EbooksHeroSection = () => (
  <Root aria-labelledby="ebooks-hero-heading">
    ...
    <Container maxWidth="xl" sx={{ position: 'relative', zIndex: 2 }}>
      <Stack spacing={3} sx={{ alignItems: 'center', textAlign: 'center' }}>
        ...
        >
          {ebooksHeroData.headline} <GradientText>{ebooksHeroData.headlineHighlight}</GradientText>
        </Typography>
