...
export const EbooksCtaSection = () => (
  <Root aria-labelledby="ebooks-cta-heading">
    <Container maxWidth="xl" sx={{ py: { xs: 8, md: 12 } }}>
      <Stack spacing={4} sx={{ alignItems: 'center', textAlign: 'center' }}>
        <SectionHeading
          headingId="ebooks-cta-heading"
          heading="Need Custom Accessibility Training or Playbooks for Your Team?"
          description="We partner with enterprises, banks, and technology organizations to deliver tailored accessibility handbooks, corporate sensitization workshops, and certified WCAG audit programs."
          tone="inverse"
          maxWidth={760}
        />
